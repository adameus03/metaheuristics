...
void* neighbour(const void* r2Cart, const double temperature) {
    ...
    /*if (_neighR2Cart.x > constraint.xMax) {
        _neighR2Cart.x = constraint.xMax;
    }
    else if (_neighR2Cart.x < constraint.xMin) {
        _neighR2Cart.x = constraint.xMin;
    }

    if (_neighR2Cart.y > constraint.yMax) {
        _neighR2Cart.y = constraint.yMax;
    }
    else if (_neighR2Cart.y < constraint.yMin) {
        _neighR2Cart.y = constraint.yMin;
    }*/
